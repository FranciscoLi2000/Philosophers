...
*/
static intcheck_death(t_rules *rules, t_philo *philo)
{
...
*/
static intcheck_meals(t_rules *rules)
{
inti; /* loop index for philosophers */
intmeals; /* snapshot of meals eaten */
...
{
pthread_mutex_lock(&rules->philos[i].meal_mutex); /* protect meal count */
