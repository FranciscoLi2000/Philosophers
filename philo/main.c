...
*/
static intstart_threads(t_rules *rules)
{
...
*/
static voidjoin_threads(t_rules *rules)
{
inti; /* loop index for philosophers */
...
*/
static voidcleanup(t_rules *rules)
{
inti; /* loop index for arrays */
...
{
t_rulesrules; /* main shared state container */
